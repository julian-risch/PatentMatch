...
public class PgExtractor extends DefaultHandler implements Runnable, PatentMinerConstants {
  ...
  public void run() {
    ...
    if (docs.size() > 0) {
        ...
        Settings settings = Settings.builder().put(Node.NODE_NAME_SETTING.getKey(), "high-level-client").build();
        ...
        BulkProcessor.Builder builder = new BulkProcessor.Builder(restClient1::bulkAsync, listener, threadPool);
