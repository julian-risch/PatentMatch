...
public class PatentMinerGrantSingle implements PatentMinerConstants {
    ...
    public static void main(String[] args) throws IOException, KeyManagementException, CertificateException, KeyStoreException {
        ...
        FilenameFilter filter2 = new FilenameFilter() {
            ...
            public boolean accept(File dir, String name) {
                return name.contains(".zip") && name.contains("ipg") && name.contains(argument);
            }
        };
        ...
        FilenameFilter filter3 = new FilenameFilter() {
            @Override
            public boolean accept(File dir, String name) {
                return name.contains(".zip") && name.contains("pg") && !name.contains("ipg") && name.contains(argument);
            }
        };
